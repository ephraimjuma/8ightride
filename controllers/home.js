...
router.get('/',function(req,res){
    db.getAllDriver(function(err,result){
        db.getallride(function(err,result1){
        var total_driver = result.length ;
        var ride = result1.length;
         
        res.render('home.ejs',{driver : total_driver , driverlist : result, ride : ride, applist : result1});
        });
